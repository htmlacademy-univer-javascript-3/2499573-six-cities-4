...
import { cityChange, sortingSelection, colorSelectPoint, loadOffers, setOffersDataLoadingStatus, requireAuthorization, setError, setLogin, loadOfferData, sendReview} from './action';
